...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12" align="center">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="MemberModifyProc.do" align="center">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${mem.mem_id}" name="member_id">
							</div>
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${mem.mem_nickname}" name="member_nickname">
							</div>
						</div>
						...
						<div class="form-group col-md-12" align="center">
							<div class="col-md-12 buttons" align="center">
								...
								<button type="button" class="btn btn-default" onclick="location.href='MemberList.do'">목록으로</button>
							</div>
						</div>
