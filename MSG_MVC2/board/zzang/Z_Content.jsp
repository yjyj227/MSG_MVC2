			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<table class="table">
						...
						<tr>
							<td>
								<div class="col-md-12 contentarea" align="left">${fn:replace(article.z_body, replaceChar, "<br/>")}</div>
							</td>
						</tr>
						<tr>
							<td>
										...
										<c:if test="${!empty mem_id}">
											...
											<c:if
												...
												<button type="button" class="btn btn-warning"
													onclick="document.location='Z_UpdateForm.do?z_number=${article.z_number}&pageNum=${pageNum}'">수정</button>
												<button type="button" class="btn btn-danger"
													onclick="document.location='Z_DeleteForm.do?z_number=${article.z_number}&z_title=${article.z_title}&pageNum=${pageNum}'">삭제</button>
											</c:if>
										</c:if>
									</div>
								</div>
											...
											<div class="col-md-12" align="left">
												<c:if test="${comment.z_cnickname!=' '}">
													...
													<c:if
														...
														<button type="button" class="btn btn-default btn-xs"
															onclick="location.href='Z_CommentDeleteForm.do?z_cnumber=${comment.z_cnumber}&z_number=${article.z_number}&z_cref=${comment.z_cref}&z_cre_level=${comment.z_cre_level}'">삭제</button>
													</c:if>
												</c:if>
												...
												<c:if test="${!empty mem_id}">
													...
													<div class="hiddenText" id="a${comment.z_cnumber}">
														...
														<form id="zrecommentform" role="form"
															...
															name="zrecommentform" action="Z_CommentWriteProc.do">
