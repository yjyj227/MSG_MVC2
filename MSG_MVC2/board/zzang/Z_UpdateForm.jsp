...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="zupdateform" method="post" action="Z_UpdateProc.do" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='Z_List.do?z_ref=${article.z_ref}'">목록으로</button>
						</div>
