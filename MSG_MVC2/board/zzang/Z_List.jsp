...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<ul class="pagination">
				...
				<li><a href="Z_List.do?pageNum=${pgList.startPage-pgList.blockSize}&search=${search}&searchtext=${searchtext}&z_ref=${z_ref}"> < </a></li>
				</c:if>
				...
				<c:choose>
					...
					<c:otherwise>
					<a href="Z_List.do?pageNum=${i}&search=${search}&searchtext=${searchtext}&z_ref=${z_ref}">
					</c:otherwise>
				</c:choose>
					...
					<div class="col-md-offset-2 col-md-8 col-md-offset-2">
						<form action="Z_List.do" name="bus">
							...
							<select class="form-control" name="search">
								...
								<option value="z_title_z_body">제목+본문</option>
				...
				<div class="col-md-1"><button type="button" class="btn btn-default btn-sm" onclick="location.href='Z_WriteForm.do'">글쓰기</button></div>
			</div>
