			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<table class="table">
						...
						<tr>
							<td>
								<div class="col-md-12 contentarea" align="left">${fn:replace(article.m_body, replaceChar, "<br/>")}</div>
							</td>
						</tr>
						<tr>
							<td>
										...
										<c:if test="${!empty mem_id}">
											...
											<c:if
												...
												<button type="button" class="btn btn-warning"
													onclick="document.location='M_UpdateForm.do?m_number=${article.m_number}&pageNum=${pageNum}'">수정</button>
												<button type="button" class="btn btn-danger"
													onclick="document.location='M_DeleteForm.do?m_number=${article.m_number}&m_title=${article.m_title}&pageNum=${pageNum}'">삭제</button>
											</c:if>
										</c:if>
									</div>
								</div>
											...
											<div class="col-md-12" align="left">
												<c:if test="${comment.m_cnickname!=' '}">
													...
													<c:if
														...
														<button type="button" class="btn btn-default btn-xs"
															onclick="location.href='M_CommentDeleteForm.do?m_cnumber=${comment.m_cnumber}&m_number=${article.m_number}&m_cref=${comment.m_cref}&m_cre_level=${comment.m_cre_level}'">삭제</button>
													</c:if>
												</c:if>
												...
												<c:if test="${!empty mem_id}">
													...
													<div class="hiddenText" id="a${comment.m_cnumber}">
														...
														<form id="mrecommentform" role="form"
															...
															name="mrecommentform" action="M_CommentWriteProc.do">
