			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<table class="table">
						...
						<tr>
							<td>
								<form role="form" class="rankForm" name="rankForm" method="post" action="H_RateProc.do" onsubmit="return writeSave()">
								...
								<c:choose>
								<c:when test="${article11.v_like==1}"><!-- 좋아요가 1일 때 -->
									<form role="form" class="rankForm" name="rankForm2" method="post" action="H_RateProc.do" onsubmit="return writeSave()">
										<input type="hidden" name="v_number" value="${v_number}">
										<input type="hidden" name="mem_id" value="${mem_id}">
										<input type="hidden" name="v_movie" value="11">
