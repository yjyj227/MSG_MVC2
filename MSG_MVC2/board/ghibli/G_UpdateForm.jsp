...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="gupdateform" method="post" action="G_UpdateProc.do" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='G_List.do?g_ref=${article.g_ref}'">목록으로</button>
						</div>
