				...
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<div class="col-md-12">
						...
						<ul class="nav nav-pills nav-justified">
							<li class="col-md-3"><a href="G_List.do?h_ref=1">자유</a></li>
							<li class="col-md-3"><a href="G_List.do?h_ref=2">정보</a></li>
							<!-- 제이쿼리 $('li').on('click', function(){$(li).eq(1).attr('class', 'active')})와 같음 -->
							<li class="col-md-3"><a href="G_Rate.do">별점</a></li>
							<li class="col-md-3"><a href="G_List.do?h_ref=4">HOT</a></li>
						</ul>
					</div>
					...
					<table class="table">
						...
						<tr>
							<td>
								<form role="form" class="rankForm" name="rankForm" method="post" action="G_RateProc.do" onsubmit="return writeSave()">
								...
								<c:when test="${article41.v_like==1}"><!-- 좋아요가 1일 때 -->
									<form role="form" class="rankForm" name="rankForm2" method="post" action="G_RateProc.do" onsubmit="return writeSave()">
										<input type="hidden" name="v_number" value="${v_number}">
										<input type="hidden" name="mem_id" value="${mem_id}">
										<input type="hidden" name="v_movie" value="41">
