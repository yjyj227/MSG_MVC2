...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<ul class="pagination">
				...
				<li><a href="G_List.do?pageNum=${pgList.startPage-pgList.blockSize}&search=${search}&searchtext=${searchtext}&g_ref=${g_ref}"> < </a></li>
				</c:if>
				...
				<c:choose>
					...
					<c:otherwise>
					<a href="G_List.do?pageNum=${i}&search=${search}&searchtext=${searchtext}&g_ref=${g_ref}">
					</c:otherwise>
				</c:choose>
					...
					<div class="col-md-offset-2 col-md-8 col-md-offset-2">
						<form action="G_List.do" name="bus">
							...
							<select class="form-control" name="search">
								...
								<option value="g_title_g_body">제목+본문</option>
				...
				<div class="col-md-1"><button type="button" class="btn btn-default btn-sm" onclick="location.href='G_WriteForm.do'">글쓰기</button></div>
			</div>
