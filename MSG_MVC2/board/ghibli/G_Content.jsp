			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<table class="table">
						...
						<tr>
							<td>
								<div class="col-md-12 contentarea" align="left">${fn:replace(article.g_body, replaceChar, "<br/>")}</div>
							</td>
						</tr>
						<tr>
							<td>
										...
										<c:if test="${!empty mem_id}">
											...
											<c:if
												...
												<button type="button" class="btn btn-warning"
													onclick="document.location='G_UpdateForm.do?g_number=${article.g_number}&pageNum=${pageNum}'">수정</button>
												<button type="button" class="btn btn-danger"
													onclick="document.location='G_DeleteForm.do?g_number=${article.g_number}&g_title=${article.g_title}&pageNum=${pageNum}'">삭제</button>
											</c:if>
										</c:if>
									</div>
								</div>
											...
											<div class="col-md-12" align="left">
												<c:if test="${comment.g_cnickname!=' '}">
													...
													<c:if
														...
														<button type="button" class="btn btn-default btn-xs"
															onclick="location.href='G_CommentDeleteForm.do?g_cnumber=${comment.g_cnumber}&g_number=${article.g_number}&g_cref=${comment.g_cref}&g_cre_level=${comment.g_cre_level}'">삭제</button>
													</c:if>
												</c:if>
												...
												<c:if test="${!empty mem_id}">
													...
													<div class="hiddenText" id="a${comment.g_cnumber}">
														...
														<form id="grecommentform" role="form"
															...
															name="grecommentform" action="G_CommentWriteProc.do">
