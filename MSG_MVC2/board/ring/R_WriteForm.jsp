...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="rwriteform" method="post" action="R_WriteProc.do" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='R_List.do'">목록으로</button>
						</div>
