			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10 col-md-offset-1">
					...
					<table class="table">
						...
						<tr>
							<td>
								<div class="col-md-12 contentarea" align="left">${fn:replace(article.r_body, replaceChar, "<br/>")}</div>
							</td>
						</tr>
						<tr>
							<td>
										...
										<c:if test="${!empty mem_id}">
											...
											<c:if
												...
												<button type="button" class="btn btn-warning"
													onclick="document.location='R_UpdateForm.do?r_number=${article.r_number}&pageNum=${pageNum}'">수정</button>
												<button type="button" class="btn btn-danger"
													onclick="document.location='R_DeleteForm.do?r_number=${article.r_number}&r_title=${article.r_title}&pageNum=${pageNum}'">삭제</button>
											</c:if>
										</c:if>
									</div>
								</div>
											...
											<div class="col-md-12" align="left">
												<c:if test="${comment.r_cnickname!=' '}">
													...
													<c:if
														...
														<button type="button" class="btn btn-default btn-xs"
															onclick="location.href='R_CommentDeleteForm.do?r_cnumber=${comment.r_cnumber}&r_number=${article.r_number}&r_cref=${comment.r_cref}&r_cre_level=${comment.r_cre_level}'">삭제</button>
													</c:if>
												</c:if>
												...
												<c:if test="${!empty mem_id}">
													...
													<div class="hiddenText" id="a${comment.r_cnumber}">
														...
														<form id="rrecommentform" role="form"
															...
															name="rrecommentform" action="R_CommentWriteProc.do">
