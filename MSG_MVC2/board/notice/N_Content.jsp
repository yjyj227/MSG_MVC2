<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="beans.*, java.text.SimpleDateFormat"%>
...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<table class="table">
					...
					<tr>
						<td>
						<div class="col-md-12 contentarea" align="left">${fn:replace(article.not_body, replaceChar, "<br/>")}</div>
						</td>
					</tr>
					<tr>
						<td>
						...
						<button type="button" class="btn btn-default" onclick="document.location='N_List.do?pageNum=${pageNum}'">목록으로</button>
						</div>
						<div class="col-md-2"></div>
						<div class="col-md-8" align="right">
					<c:if test="${!empty mem_id}">
						<c:if test="${mem_id.equals('admin')}">
							<button type="button" class="btn btn-warning" onclick="document.location='N_UpdateForm.do?notice_number=${article.notice_number}&pageNum=${pageNum}'">수정</button>
							<button type="button" class="btn btn-danger" onclick="document.location='N_DeleteForm.do?notice_number=${article.notice_number}&pageNum=${pageNum}'">삭제</button>
						</c:if>
					</c:if>
