...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12" align="center">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="MemberInsert.do" align="center">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_passwd}" name="mem_passwd">
							</div>
						</div>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_nickname}" name="mem_nickname">
							</div>
						</div>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_birth}" name="mem_birth">
							</div>
						</div>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_tel}" name="mem_tel">
							</div>
						</div>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_addr}" name="mem_addr">
							</div>
						</div>
						</div>
						
						<div class="form-group genreform">
						<div class="col-md-12">
							<label for="name" class="col-md-3 control-label" align="right">관심장르</label>
							<div class="col-md-6">
								<input type="text" class="form-control" value="${regmem.mem_genre}" name="mem_genre">
							</div>
						</div>
						</div>
