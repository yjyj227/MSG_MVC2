...
<script LANGUAGE="JavaScript" src="./js/scripts.js?ver=1">
</script>
...
<body id="page-top" class="bg-dark" onload="regForm.mem_id.focus()">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12" align="center">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="RegisterProc.do" align="center">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-6">
								<input type="date" id="birth" class="form-control" placeholder="생일" name="mem_birth">
							</div>
						</div>
